        ...
        <div class="modal-body" style="padding:40px 50px;">
          ...
          <span>
             <div class="form-group">
                   <label for="images">IMAGE</label><input type='file' onchange="readURL(this);" name="images"/>
                         </br>
              ...
              <input type="text" class="form-control" name="image_caption" placeholder="Enter caption" value="{{ old('image_caption') }}">
            </div>
            <div class="form-group">
              <label for="header">HEADER</label>
              <input type="text" class="form-control" name="header" placeholder="Enter subheader" value="{{ old('header') }}">
            </div>
             <div class="form-group">
              <label for="content">CONTENT</label>
                {!! Form::textarea('content',null,array('class'=>'form-control','id'=>'message')) !!}
            </div>
