  ...
  <td>{!!$data->caption!!}</td>
   <td>{!!$data->detail!!}</td>
    <td>{!! Form::open(['method'=>'DELETE', 'action'=>['newmenucontroller@menudestroy',$data->id,$id]]) !!}
                  <span>{!! link_to_action('newmenucontroller@menuedit', '', array($data->id,$id), array('class' => 'glyphicon glyphicon-pencil' )) !!}<spamyBtnn>
        ...
        <div class="modal-body" style="padding:40px 50px;">
          ...
          <span>
             <div class="form-group">
              ...
              <input type="text" class="form-control" name="caption" placeholder="Enter header">
            </div>
            <div class="form-group">
              <label for="detail">DETAIL</label>
               {!! Form::textarea('detail',null,array('class'=>'form-control','id'=>'message')) !!}
            </div>
